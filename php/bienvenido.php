    ...
    if ($_SESSION['fname'] == "admin"){
	    ...
	    if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                $id = $row["id"];
                //$_SESSION[$id];
                echo("<input style='background-color: #705022; align-content: center;' type='submit' name='' method='post' value='Respondido' id='btRes' onclick = 'location.href='deleteEntry.php';'>". "<br><hr>");
